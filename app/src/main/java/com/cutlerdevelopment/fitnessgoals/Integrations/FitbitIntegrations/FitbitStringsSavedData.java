...
public class FitbitStringsSavedData {

    public static void createFitbitStringsSavedDataInstance(Context c) {
        new FitbitStringsSavedData(c);
    }
    private static FitbitStringsSavedData instance = null;

    public static FitbitStringsSavedData getInstance() {
        if (instance != null) {
            return instance;
        }
        return null;
    ...
    private FitbitStringsSavedData(Context context) {
        instance = this;
