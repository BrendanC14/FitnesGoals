...
public class FirstMenu extends AppCompatActivity implements IntegrationConnectionHandler.IntegrationListener {
    ...
    /**
     * Populates the teamNameColour spinner.
     * If they've chosen Team Mode the spinner is populated with colours, controlled by Colours.NUM_TEAM_COLOURS.
     * If they've chosen Player Mode the spinner is populated wit team names. List of names taken from Words.teamNames.
     */
